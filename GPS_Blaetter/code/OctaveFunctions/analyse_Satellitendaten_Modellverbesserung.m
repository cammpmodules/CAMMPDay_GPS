function [delta_tS,SK, dS, SP, delta_tE, GK, VGK] = analyse_Satellitendaten_Modellverbesserung(tE, tS, Ephemeriden)
...
[X,fval,info,iterations] = fsolve(Funktion,StartP,options);
